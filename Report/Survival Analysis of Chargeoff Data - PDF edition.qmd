...
res.cox = coxph(Surv(Time_to_Charge_Off, Is_Censored) ~ 
  Effective_Annual_Interest_Rate + strata(Application_Code), data = logChargeoff)
...
badLoan = data.frame( Monthly_Payment = log(1000), 
  Effective_Annual_Interest_Rate = log(0.25), Application_Code = "CI")
badLoan
goodLoan = data.frame( Monthly_Payment = log(100), 
  Effective_Annual_Interest_Rate = log(0.025), Application_Code = "CI")
goodLoan
```
